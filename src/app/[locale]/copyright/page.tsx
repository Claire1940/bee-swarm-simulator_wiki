...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Bee Swarm Simulator Wiki',
    description: 'Copyright and intellectual property information for Bee Swarm Simulator Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Bee Swarm Simulator Wiki',
      description: 'Copyright and intellectual property information for Bee Swarm Simulator Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Bee Swarm Simulator Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Bee Swarm Simulator Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Bee Swarm Simulator Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox Corporation</strong> - Owner of the Roblox platform</li>
              <li><strong>Onett</strong> - Developer of the Bee Swarm Simulator game</li>
            </ul>
            <p>
              All game-related content, including but not limited to:
            </p>
            <ul>
              <li>Bee images and artwork</li>
              <li>Game screenshots and interface elements</li>
              <li>Game logos and branding</li>
              <li>Bee names and abilities</li>
              <li>In-game items, fields, and mechanics</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Bee Swarm Simulator</strong> - Trademark of the game developer Onett</li>
              <li><strong>Bee Swarm Simulator Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Bee Swarm Simulator Wiki.
            </p>
            ...
            <p>
              ...
              Bee Swarm Simulator Wiki<br />
              Email: <a href="mailto:dmca@bee-swarm-simulator.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@bee-swarm-simulator.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Bee Swarm Simulator Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Bee Swarm Simulator Wiki (bee-swarm-simulator.wiki)"</em>
            </p>
            ...
            <p>
              ...
              upon posting to the website. The "Last Updated" date at the top of this page indicates when the notice was
              last revised.
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@bee-swarm-simulator.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@bee-swarm-simulator.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@bee-swarm-simulator.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@bee-swarm-simulator.wiki</a>
            </p>
            <p>
