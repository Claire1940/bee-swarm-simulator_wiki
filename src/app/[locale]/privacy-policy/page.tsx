...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Bee Swarm Simulator Wiki',
    description: 'Bee Swarm Simulator Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Roblox game resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Bee Swarm Simulator Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Roblox, Discord, Reddit, YouTube, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Bee Swarm Simulator Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Roblox Corporation, the game's developer Onett, or the official Bee Swarm Simulator brand. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@bee-swarm-simulator.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@bee-swarm-simulator.wiki</a>
            </p>
            <p>
