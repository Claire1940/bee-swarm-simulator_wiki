...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Bee Swarm Simulator Wiki",
    description: "Read the Terms of Service for Bee Swarm Simulator Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Bee Swarm Simulator Wiki",
      description: "Terms and conditions for using Bee Swarm Simulator Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Bee Swarm Simulator Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Bee Swarm Simulator Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Bee Swarm Simulator Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Bee Swarm Simulator Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Bee Swarm Simulator" (developed by Onett). Our services include, but are not limited to:
            </p>
            <ul>
              <li>Active, expired, and unverified code lists</li>
              <li>Bee tier lists and event bee guides</li>
              <li>Hive build templates (red, blue, white hives)</li>
              <li>Gear and tool upgrade guides</li>
              <li>Bear quest walkthroughs</li>
              <li>Sticker collecting and trading value guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Bee Swarm Simulator Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation, the game's developer Onett, or the official Bee Swarm Simulator brand. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Bee Swarm Simulator Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Game Content</h3>
            <p>
              All game-related content, including but not limited to bee images, game screenshots, logos, and
              trademarks, are the property of Roblox Corporation and/or the developer Onett. We use such
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate information, but we do not guarantee that all content is current, complete, or error-free. Game updates may render information outdated, and codes may expire without notice.</li>
              ...
              <li><strong>Code Validity:</strong> Codes may expire, change, or be region-locked by the developer. We are not responsible for codes that no longer work.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, BEE SWARM SIMULATOR WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Roblox, Discord, Reddit, YouTube, social media platforms,
            ...
            <p>
              ...
              you and Bee Swarm Simulator Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@bee-swarm-simulator.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@bee-swarm-simulator.wiki</a>
            </p>
            <p>
